...
param_1="scf-1e-2 scf-1e-3 scf-5e-4 scf-3e-4 scf-2e-4 scf-1e-4 scf-5e-5 scf-1e-5 scf-5e-6 scf-1e-6 scf-5e-7 scf-1e-7"
...
printf "%s %f" "Total SCF" $scf_sum >> $data_output_1
